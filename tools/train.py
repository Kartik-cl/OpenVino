...
def parse_args():
    ...
    parser.add_argument('--bs_per_gpu', type=int, default=8,  dest='batch_size_per_gpu',
    ...
    parser.add_argument('--checkpoint_interval', type=int, default=600,
    ...
    parser.add_argument('--lr', default=0.0004, type=float,
                        help='Initial learning rate') #.0002#0.00002 # decrease lr 0.0000002 --> previous one
    ...
    parser.add_argument('--warmup_iters', default=0, type=int,
                        help='Number of iterations for warm up')#1000 #kartikeya
    ...
    parser.add_argument('--max_iter', default=3000, type=int,
                        help='Maximum number of iterations')#changed from 9000 kartikeya
...
def main(args):
    ...
    print(train_dataset.classes_num)
    ...
    #train_tool.model = locate(args.model)(3) #kartikeya
